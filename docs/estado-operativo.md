...
Actualizado: 2026-09-08T21:57:07+02:00
...
Ejecutar el postflight mínimo de la extensión contractual `VisualContext` antes de corregir o revisar `a1-u1-candidate-v3`. No iniciar endpoint, frontend, loader, admission, publication, membership, activación ni B181. A1 L1 v3 permanece inactiva, A1-U1 `pending / non-member` y `LOADER = BLOCKED`.
