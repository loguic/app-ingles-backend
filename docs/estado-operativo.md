...
Actualizado: 2026-09-09T18:34:00+02:00
...
Corrección A1 v3 local: `content/candidates/a1-u1/pedagogical-unit-candidate-v3.json` incorpora comprensión MCQ visual, tres contextos visuales tipados, modelos en-GB-first y decisiones de ayuda/feedback documentadas. `content/candidates/a1-u1/human-review-v3.md` queda **HUMAN APPROVED**; esta actualización sustituye la indicación histórica anterior de bloqueo. Las decisiones pedagógicas están cerradas y solo queda el cierre Git/publicación del checkpoint. No hay admission, membership, activación, frontend, loader, DB, `content/content_tree.json` ni B181.
...
Realizar únicamente el cierre Git/publicación del checkpoint de `a1-u1-candidate-v3` HUMAN APPROVED. No iniciar frontend, loader, admission, membership, activación ni B181. A1 L1 v3 permanece inactiva, A1-U1 `pending / non-member` y `LOADER = BLOCKED`.
