...
Actualizado: 2026-09-07T14:52:31+02:00
...
- no rediseñar `PedagogicalUnitSpecification.prerequisites`, `SkillCoverage`, `required_stages`, `ExperienceEvidenceState`, completion, progreso, mastery, fonética, feedback ni B181; Incremento 2 integró exclusivamente los estados existentes y queda pendiente solo de cierre Git;
...
Cerrar Git exclusivamente Incremento 2 — puente de evaluación oral cualitativa hacia `evidence states`; no iniciar ningún frente posterior, endpoint, frontend, candidata aislada ni loader en esta ejecución. La ruta hacia B181 sigue exigiendo candidata construida, validada y revisada antes de una nueva validación humana. A1 L1 v3 permanece inactiva, B181 pausado, A1-U1 `pending / non-member` y `LOADER = BLOCKED`.
