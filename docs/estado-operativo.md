...
Actualizado: 2026-09-09T20:58:00+02:00
...
Materializar únicamente la membership preparada de A1-U1 cuando se autorice: publicar el manifest ya preparado en su ruta futura, sin iniciar B52, recursos físicos, activación, frontend, loader ni trabajo B181. A1 L1 v3 permanece inactiva, A1-U1 `non-member` durable y `LOADER = BLOCKED`.
