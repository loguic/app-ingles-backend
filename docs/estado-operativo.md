...
Actualizado: 2026-09-07T15:27:14+02:00
...
Preparar únicamente una nueva `PedagogicalUnitSpecification` aislada y concreta para aprobación humana; no generar candidata todavía. No iniciar endpoint, frontend, loader, admission, publication, membership ni B181. A1 L1 v3 permanece inactiva, A1-U1 `pending / non-member` y `LOADER = BLOCKED`.
