...
Actualizado: 2026-09-09T22:13:57+02:00
...
Producir únicamente los assets A1-U1 una vez aprobados humanamente, siguiendo `content/resources/a1-u1/README.md`; después se fijarán expected identities y podrá prepararse B52. No iniciar B52, activación, frontend, loader ni trabajo B181. A1 L1 v3 permanece inactiva, A1-U1 es `member durable / not active` y `LOADER = BLOCKED`.
