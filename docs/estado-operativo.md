...
Actualizado: 2026-09-23T16:43:20+02:00
Baseline Git previa a este checkpoint: 824a4512e3e3bed1f9d950d66a80a50b59d2a3e1
...
## Bloque activo
`A1 — reentrada canónica / Puerta 3 preflight`: la specification `content/candidates/a1-u1/pedagogical-unit-specification-v3.json` está **HUMAN APPROVED AS CANONICAL BASIS FOR A1 v4** por identidad exacta con la specification embebida en candidate v4, cuyo digest es `sha256:e75a5c9864adb86a3152e67ab9c97951372e11ed5400b70406f033e6f70b9a8d`; candidate v4 permanece **HUMAN APPROVED**. El trabajo siguiente es read-only y no es implementación: preflight específico de Puerta 3 y prerequisitos de activación A1. B completo permanece **CLOSED / PUBLISHED / SYNCED** en `25678e7c07bd249f03ea33dbe815d4d3d0b9e901`, sin Subpaso 4. A1 v4 permanece **MEMBER DURABLE / NOT ACTIVE**; Puerta 3 no iniciada; B181 **PAUSED**; B52 **NOT VERIFIED**; loader **BLOCKED**; human reviews TTS **NOT STARTED**; winner **NOT SELECTED**.
...
NEXT = preflight read-only específico de Puerta 3 y prerequisitos de activación A1
