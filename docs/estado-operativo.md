...
Actualizado: 2026-09-09T21:03:41+02:00
...
Realizar únicamente el cierre Git del manifest durable de membership A1-U1. No iniciar B52, recursos físicos, activación, frontend, loader ni trabajo B181. A1 L1 v3 permanece inactiva, A1-U1 es `member durable / not active` y `LOADER = BLOCKED`.
