...
Actualizado: 2026-09-11T20:01:18+02:00
...
Producir únicamente los 14 assets A1-U1 restantes queda congelado hasta reconciliar `a1_resource_asset_close.py` con Candidate v4. La revisión humana, Admission y membership durable de Candidate A1-U1 v4 están cerradas; no iniciar TTS, B52, activación, frontend/loader ni B181 antes de esa reconciliación. V3 permanece histórica; v4 está `human approved / admitted / member durable / not active`.
