...
Actualizado: 2026-09-11T19:22:53+02:00
...
Revisión focal A1-U1 Candidate v4 = **HUMAN REVIEW APPROVED** en `content/candidates/a1-u1/pedagogical-unit-candidate-v4.json`, con `candidate_revision=a1-u1-candidate-v4`, único delta canónico `help` en-GB `/hɛlp/` → `/help/` y digest confirmado `sha256:e75a5c9864adb86a3152e67ab9c97951372e11ed5400b70406f033e6f70b9a8d`. V4 = **NOT ADMITTED / NOT MEMBER / NOT ACTIVE**: esta aprobación no autoriza AdmissionRecord, membership ni snapshot. El postflight inicial detectó y bloqueó una incorporación retroactiva de la coherencia IPA al validador global; la corrección conserva esa prevención como comprobación focal de v4, restaura la validación y B43 positivos de v3 y deja pendiente un diseño posterior de prevención general versionada. Candidate v3, `adm-a1-u1-001` y `active-candidate-source-001` permanecen byte-identical como historia. El lote TTS queda congelado hasta una nueva Admission y membership/snapshot v4. Los cuatro assets visuales ya aprobados siguen reutilizables byte-identical; PHYSICAL ASSETS = **4/18 APPROVED**, WAV = **0**, B52 = **NOT VERIFIED**, `LOADER = BLOCKED` y B181 = **PAUSED**.
...
Producir únicamente los 14 assets A1-U1 restantes queda congelado hasta una nueva Admission y membership/snapshot v4. La revisión humana de Candidate A1-U1 v4 está aprobada; el siguiente frente requiere una decisión separada de Admission. No producir TTS, crear AdmissionRecord o snapshot v4, iniciar B52, activar contenido, tocar frontend/loader ni reanudar B181. V3 permanece histórica; v4 está `human approved / not admitted / not member / not active`.
