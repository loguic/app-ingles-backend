...
La aprobación humana de `content/candidates/a1-u1/pedagogical-unit-candidate-v4.json` cubre también su specification embebida cuando esta es exactamente idéntica a `content/candidates/a1-u1/pedagogical-unit-specification-v3.json`. Por tanto, la specification v3 queda **HUMAN APPROVED AS CANONICAL BASIS FOR A1 v4**, preservando candidate v4 **HUMAN APPROVED** y su digest `sha256:e75a5c9864adb86a3152e67ab9c97951372e11ed5400b70406f033e6f70b9a8d`. Esta aclaración no crea approval record independiente ni schema nuevo, y no modifica `human-review-v4.md`, candidate v4, specification v3 ni ningún digest histórico. No ejecuta Puerta 3, no activa A1, no modifica `content/content_tree.json`, no abre candidata, no reactiva B181 ni altera B52 o loader. A1 v4 permanece **MEMBER DURABLE / NOT ACTIVE**; B181 **PAUSED**; B52 **NOT VERIFIED**; loader **BLOCKED**; human reviews TTS **NOT STARTED**; winner **NOT SELECTED**.
