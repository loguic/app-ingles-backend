...
Permanecen como límites no bloqueantes fuera de v1 la simulación directa de una carrera entre stage y commit y el hardening de remote names que comiencen por `-`. La siguiente frontera funcional del producto no cambia: preflight de la representación física explícita de `ActiveCandidateSourceSnapshot`, antes de source integrity, adquisición y loader.
