...
Entrada A1 canónica — A1 v3 y A1 v4 están publicados. A1 v4 permanece **MEMBER DURABLE / NOT ACTIVE**: no autoriza activar A1, cargar contenido ni reanudar B181. Solo están aprobados cuatro assets visuales A1 (`water`, `food`, `need` y `greeting`). B52 continúa **NOT VERIFIED**, el loader permanece **BLOCKED** y `content/content_tree.json` no se modifica.
