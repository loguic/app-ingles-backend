...
Entrada A1 canónica — A1 v3 y A1 v4 están publicados. A1 v4 permanece **MEMBER DURABLE / NOT ACTIVE**: no autoriza activar A1, cargar contenido ni reanudar B181. Además de los cuatro assets visuales A1 (`water`, `food`, `need` y `greeting`), doce muestras WAV concretas recibieron aprobación humana directa como assets físicos A1-U1. Esta aprobación no completa las human blind reviews formales, no selecciona winner ni cierra Puerta 3. B52 continúa **NOT VERIFIED**, el loader permanece **BLOCKED**, B181 sigue **PAUSED** y `content/content_tree.json` no se modifica.

TTS WAV normalization profile v1 y TTS Engine Benchmark Protocol v1 están publicados. La ejecución externa anclada a `3e10e97a932f6be27cc05081ba02c555d4611565` está **TÉCNICAMENTE FINALIZADA**. Doce WAV concretos fueron aprobados directamente como assets físicos A1-U1; esta aprobación no es la human blind review formal del benchmark, cuya situación sigue **NOT STARTED**, ni selecciona winner, que sigue **NOT SELECTED**. La reconciliación privada A/B está **CLOSED / PUBLISHED / SYNCED** en `4d26cf2f3557266b30c26328dbe6f7f76a5e61d9`; Puerta 3 no queda cerrada automáticamente.
...
La reconciliación vigente establece que B ya está **CLOSED / PUBLISHED / SYNCED** y deja de ser el bloque activo. La specification `pedagogical-unit-specification-v3.json` está **HUMAN APPROVED AS CANONICAL BASIS FOR A1 v4**; candidate v4 permanece **HUMAN APPROVED**. El siguiente objetivo es el preflight read-only específico de Puerta 3 y prerequisitos de activación A1. Puerta 3 no ha sido ejecutada; A1 v4 permanece **MEMBER DURABLE / NOT ACTIVE**; B181 **PAUSED**; B52 **NOT VERIFIED**; loader **BLOCKED**.
