...
Entrada A1 canónica — A1 v3 y A1 v4 están publicados. La reconciliación de assets quedó **CLOSED / PUBLISHED / SYNCED** en `824a4512e3e3bed1f9d950d66a80a50b59d2a3e1`; el cierre canónico de los doce WAV aprobados se publicó en `cd19bb764177f23754497d914d7d9f3948b7a389`. A1 v4 permanece **MEMBER DURABLE / NOT ACTIVE**: no autoriza activar A1, cargar contenido ni reanudar B181. El estado físico aprobado es **16/18**: cuatro visuales y doce WAV concretos; permanecen `scene-help.mp4` y `option-farewell.png`. Esta aprobación no completa las human blind reviews formales, no selecciona winner ni cierra Puerta 3. B52 continúa **NOT VERIFIED**, el loader permanece **BLOCKED**, B181 sigue **PAUSED** y `content/content_tree.json` no se modifica.

TTS WAV normalization profile v1 y TTS Engine Benchmark Protocol v1 están publicados. La ejecución externa anclada a `3e10e97a932f6be27cc05081ba02c555d4611565` está **TÉCNICAMENTE FINALIZADA**. Los doce WAV concretos aprobados directamente como assets físicos A1-U1 quedaron instalados mediante el cierre `cd19bb764177f23754497d914d7d9f3948b7a389`; esta aprobación no es la human blind review formal del benchmark, cuya situación sigue **NOT STARTED**, ni selecciona winner, que sigue **NOT SELECTED**. Permanecen pendientes `scene-help.mp4` y `option-farewell.png`. La reconciliación privada A/B está **CLOSED / PUBLISHED / SYNCED** en `4d26cf2f3557266b30c26328dbe6f7f76a5e61d9`; Puerta 3 no queda cerrada automáticamente.
...
La reconciliación vigente establece que B ya está **CLOSED / PUBLISHED / SYNCED** y deja de ser el bloque activo. La specification `pedagogical-unit-specification-v3.json` está **HUMAN APPROVED AS CANONICAL BASIS FOR A1 v4**; candidate v4 permanece **HUMAN APPROVED**. El siguiente objetivo es producir el candidato concreto de `scene-help.mp4` para revisión humana. Puerta 3 no ha sido ejecutada ni cerrada; A1 v4 permanece **MEMBER DURABLE / NOT ACTIVE**; B181 **PAUSED**; B52 **NOT VERIFIED**; loader **BLOCKED**.

Human Gate registrado para los dos briefs visuales restantes: `scene-help.mp4` debe mostrar, en lenguaje visual ordinario, a una persona usando una máquina que se detiene, un intento fallido de volver a usarla y una mirada hacia otra persona cercana porque necesita ayuda; no debe aparecer inglés escrito ni hablado y debe entenderse como «I need help». `option-farewell.png` debe mostrar a dos personas terminando una interacción, despidiéndose con la mano y comenzando a alejarse; no debe aparecer inglés escrito y debe distinguirse claramente de un saludo inicial. El gate aprueba el significado pedagógico, no los archivos físicos ni sus parámetros técnicos internos. El estado físico permanece **16/18** hasta la producción y aprobación humana de los dos archivos.

Human Review Gate del storyboard de `scene-help.mp4`: **APPROVED**. La secuencia aprobada es: una persona usa una máquina; la máquina funciona; la máquina se detiene o falla; la persona lo intenta de nuevo; la persona busca o pide ayuda a otra persona. La aprobación es únicamente del storyboard; `scene-help.mp4` todavía requiere producción y su propio Human Review Gate final. `option-farewell.png` permanece como candidato externamente aprobado, aún no canonicalizado.
