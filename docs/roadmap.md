...
Las brechas demostradas para una candidata ejecutable son contexto visual mínimo, canónico y accesible, y conexión de evaluación oral cualitativa con `evidence states`. Persistencia de uso de ayudas y adaptación del perfil Direct English v3 quedan condicionadas a necesidad demostrada por una candidata real. La única autorización siguiente es preparar la especificación/candidata aislada y delimitar los mínimos cambios demostrados; no se asigna identificador nuevo ni se autoriza implementación, activación, loader o reanudación de B181.
