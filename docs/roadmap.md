...
La reconciliación vigente establece que B ya está **CLOSED / PUBLISHED / SYNCED** y deja de ser el bloque activo. La specification `pedagogical-unit-specification-v3.json` está **HUMAN APPROVED AS CANONICAL BASIS FOR A1 v4**; candidate v4 permanece **HUMAN APPROVED**. El siguiente objetivo es producir candidatos concretos de `scene-help.mp4` y `option-farewell.png` para revisión humana. Puerta 3 no ha sido ejecutada ni cerrada; A1 v4 permanece **MEMBER DURABLE / NOT ACTIVE**; B181 **PAUSED**; B52 **NOT VERIFIED**; loader **BLOCKED**.
